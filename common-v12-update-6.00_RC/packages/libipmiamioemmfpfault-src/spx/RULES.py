...
#-------------------------------------------------------------------------------------------------------
# Rules to create libipmiamioemmfpfault package
def build_package_libipmiamioemmfpfault():
	...
	if retval != 0:
		return retval
	retval = Py_CopyFile(BUILD+"/"+PACKAGE+"/data/libipmiamioemmfpfault.so."+PrjVars["PKG_MAJOR"]+"."+PrjVars["PKG_MINOR"]+"."+PrjVars["PKG_AUX"],TEMPDIR+"/"+PACKAGE+"/tmp")
	if retval != 0:
		return retval
