...
#-------------------------------------------------------------------------------------------------------
# Rules to create libipmiamioemmfpvalid package
def build_package_libipmiamioemmfpvalid():
	...
	if retval != 0:
		return retval
	retval = Py_CopyFile(BUILD+"/"+PACKAGE+"/data/libipmiamioemmfpvalid.so."+PrjVars["PKG_MAJOR"]+"."+PrjVars["PKG_MINOR"]+"."+PrjVars["PKG_AUX"],TEMPDIR+"/"+PACKAGE+"/tmp")
	if retval != 0:
		return retval
